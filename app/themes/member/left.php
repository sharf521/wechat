<div class="warpleft">
    ...
    <ul>
        ...
        <li><a href="<?=url('/member/order')?>"  <? if($this->control=='order'){echo 'class="whover"';}?>>我的订单</a></li>
    </ul>
    ...
    <? else: ?>
        ...
        <ul>
            ...
            <li><a href="<?=url('/sellManage/order')?>"  <? if($this->control=='order'){echo 'class="whover"';}?>>我的订单</a></li>
