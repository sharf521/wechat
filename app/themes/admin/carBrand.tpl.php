...
<? if ($this->func == 'index') : ?>
    <blockquote class="layui-elem-quote">
        <span>品牌管理</span>列表
        <a href="<?= url('carBrand/add/') ?>" class="layui-btn layui-btn-small">添 加</a>
    </blockquote>
            ...
            <table class="layui-table" lay-skin="line">
                ...
                <? foreach ($list as $row) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= url("carBrand/edit/?id={$row->id}&page={$_GET['page']}") ?>" class="layui-btn layui-btn-mini">修改</a>
...
<? elseif ($this->func == 'add' || $this->func == 'edit') : ?>
    <blockquote class="layui-elem-quote"><span>品牌管理</span><? if ($this->func == 'add') { ?>新增<? } else { ?>编辑<? } ?>
        <a href="<?= url('carBrand') ?>" class="layui-btn layui-btn-small">返回列表</a></blockquote>
    <div class="main_content">
            ...
            <div class="layui-field-box">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <button type="button" class="layui-btn upload_btn" upload_id="article" upload_type="carBrand">
