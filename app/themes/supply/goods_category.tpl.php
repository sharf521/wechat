        ...
        <div class="warpright">
            <div class="box">
                ...
                <? if(empty($cates) || empty($shippings)) : ?>
                    <? if(empty($cates)) : ?>
                        <blockquote class="layui-elem-quote">暂无添加店铺分类，<a href="<?=url('/sellManage/category/add')?>" class="layui-btn layui-btn-mini">添加</a></blockquote>
                    <? endif;?>
                    <? if(empty($shippings)) : ?>
                        <blockquote class="layui-elem-quote">暂无添加配送方式，<a href="<?=url('/sellManage/shipping/add')?>" class="layui-btn layui-btn-mini">添加</a></blockquote>
                    <? endif;?>
                <? else : ?>
                <form method="post">
                    <div id="div_category">
